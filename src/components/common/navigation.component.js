        ...
        return (
            <nav className="navigation">
                <ul className="navigation-items">
                    ...
                    <li className={this.props.activeTab === 'cart'      ? 'navigation-item-active' : 'navigation-item'} onClick={() => browserHistory.push('/cart')}>Cart({shoppingCartService.getCartSize()})</li>
